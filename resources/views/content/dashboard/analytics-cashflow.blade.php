              ...
              <table class="table table-hover table-striped-columns mb-0 align-middle table-pn-report">
                ...
                <tbody>
                  ...
                  <tr class="table-primary fw-bold border-top border-2">
                    <td class="text-primary" style="font-size: 1.1rem;">
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header d-flex align-items-center text-white" style="background-color: #960b10ff !important;">
          <h5 class="modal-title d-flex align-items-center text-white mb-4" id="cashflowGroupDetailModalLabel"
            style="color: #ffffff !important;">
            <i class="bx bx-detail me-2 fs-4 text-white" style="color: #ffffff !important;"></i>
            <span id="cashflowGroupDetailTitle" class="text-white" style="color: #ffffff !important;">Detail Cash Flow</span>
          </h5>
