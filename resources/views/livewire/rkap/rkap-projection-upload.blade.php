        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 border-lg-end pe-lg-4 mb-4 mb-lg-0">
              ...
              <div class="alert alert-primary mb-4 shadow-none border-1 rkap-bg-alert-primary" role="alert">
                <div class="d-flex align-items-center gap-2 mb-2">
                  <i class="bx bx-download fs-5 text-primary"></i>
                  <strong class="text-primary">Download Template Proyeksi</strong>
                </div>
                <p class="small text-dark mb-3 rkap-lh-14">
                  Gunakan file template yang berisi data RKAP periode terpilih dengan seluruh item anggaran yang disetujui (Approved).
                  Kolom proyeksi bulan berjalan s.d. Desember dapat diisi, whereas bulan yang sudah lalu akan dikunci secara otomatis.
                </p>
                <div class="d-flex flex-wrap gap-2">
                  <a href="{{ route('rkap-projection-template-download', ['period_id' => $periodId]) }}"
                    class="btn btn-sm btn-primary d-inline-flex align-items-center gap-1">
                    <i class="bx bx-file"></i>
                    Excel (.xlsx) <span class="badge bg-white text-primary ms-1 rkap-font-065">Terisi Data Riil</span>
                  </a>
                </div>
                <div class="mt-3 small text-muted rkap-font-08 rkap-lh-14">
                  <ul class="mb-0 ps-3">
              ...
              <div class="alert alert-danger shadow-none border-1">
                ...
                <div class="border rounded bg-white p-2 rkap-dropdown-scroll">
            ...
            <div class="col-lg-6 ps-lg-4">
              <div class="border rounded p-3 bg-light rkap-border-dashed-muted">
