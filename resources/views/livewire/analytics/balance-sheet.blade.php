<div>
    <h4 class="mb-4">Balance Sheet (Neraca)</h4>
                ...
                <table class="table table-sm table-bordered table-hover align-middle mb-0" x-data="balanceSheetTable()">
                    ...
                    <tfoot class="table-light fw-bold">
                        ...
                        <tr class="{{ ($balOpening == 0 && $balBudget == 0 && $balReal == 0 && $balProj == 0) ? 'table-success' : 'table-danger' }}">
                            ...
                            <td class="text-center">
                                @if($balOpening == 0 && $balBudget == 0 && $balReal == 0 && $balProj == 0)
                                    <i class="bx bx-check-circle fs-4 text-success"></i>
                                @else
                                    <i class="bx bx-x-circle fs-4 text-danger" title="Neraca tidak seimbang"></i>
                                @endif
                            </td>
                        </tr>
                    </tfoot>
