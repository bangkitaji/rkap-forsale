    ...
    <div class="col-md-12">
      <div class="nav-align-top">
        <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-md-0 gap-2">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="javascript:void(0);"><i class="icon-base bx bx-check-shield icon-sm me-1_5"></i> Roles</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('settings-user-management-permissions') }}"><i class="icon-base bx bx-key icon-sm me-1_5"></i> Permissions</a>
          </li>
        </ul>
      </div>
    </div>
