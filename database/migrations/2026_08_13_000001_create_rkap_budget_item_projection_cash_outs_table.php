...
return new class extends Migration
{
    ...
    {
        Schema::create('rkap_budget_item_projection_cash_outs', function (Blueprint $table) {
            $table->id();
            ...
            // Ensure unique projection cash out per budget item per month
            $table->unique(['rkap_budget_item_id', 'month'], 'unique_item_month_proj_cashout');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('rkap_budget_item_projection_cash_outs');
    }
};
